...
class Bundler::Dependencies::Partial_Threshold_Matrix {
    use Bundler::Dependencies::APPLES_Datatypes qw(APPLESSpeciesName Boolean);
    use Bundler::Dependencies::Evolutionary_Tree;
    use constant {FALSE => 0,
		  TRUE => 1};
    use Data::Dumper;
    use Bundler::Dependencies::General_Utilities;

    has 'evolutionary_tree' => (is => 'ro', isa => 'Bundler::Dependencies::Evolutionary_Tree', required => 1);
