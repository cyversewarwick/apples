...
class Bundler::Dependencies::Exception {
  has 'message' => (is => 'rw', isa => 'Str');
} # Exception #

class Job_Information_Exception extends Bundler::Dependencies::Exception {
...
class Aggregate_Exception extends Bundler::Dependencies::Exception {
  use Data::Dumper;
    use Bundler::Dependencies::APPLES_Datatypes qw (NonNegativeNum NonNegativeInt);
...
class No_Neighbouring_Gene_Exception extends Bundler::Dependencies::Exception {

} # No_Neighbouring_Gene_Exception #

class Web_Service_Parameters_Inconsistent extends Bundler::Dependencies::Exception {
